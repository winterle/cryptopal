require 'stringio'
# altered implementation from: https://rosettacode.org/wiki/MD4#Ruby
# Calculates MD4 message digest of _string_. Returns binary digest.
# For hexadecimal digest, use +*md4(str).unpack('H*')+.


# a,b,c,d registers are defaulted to the 'magic numbers'
def md4(string,a=0x67452301,b = 0xefcdab89,c =0x98badcfe,d = 0x10325476)
    # functions
    mask = (1 << 32) - 1
